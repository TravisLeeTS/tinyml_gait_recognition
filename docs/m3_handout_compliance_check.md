...
| R3 optimization with before/after comparison | Complete | `tinyml_milestone3.pdf`, `README_MILESTONE3.md`, `docs/tables/m3_retrained_model_comparison.md` | Shows M2 UCI-only DS-CNN versus M3 V2.1 mixed 6-channel INT8 candidate, including target-domain adaptation and INT8 size improvement. |
...
| R6 challenges and lessons learned | Complete | `tinyml_milestone3.pdf`, `README_MILESTONE3.md` | Documents UCI-to-Arduino domain shift, placement sensitivity, orientation dependence, stair-direction confusion, and replay versus live Serial mismatch. |
| R7 plan for M4 | Complete | `tinyml_milestone3.pdf` | Includes more stair data, fixed orientation, calibration pose, orientation-aware features, placement-specific models/calibration, and M4 robustness work. |
...
| Placement/orientation limitations | Complete | `tinyml_milestone3.pdf`, `README_MILESTONE3.md`, `arduino/tinyml_har_m3/README.md` | Reports right-pocket recommendation, left-pocket orientation matching, static posture angle sensitivity, walking style sensitivity, and stair-direction weakness. |
